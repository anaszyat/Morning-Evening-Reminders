      ...
      >
        ...
        <View style={styles.row}>
          <View style={styles.right}>
            <Text style={[styles.salam, { fontFamily: "Tajawal_400Regular" }]}>
              السلام عليكم
            </Text>
            <Text style={[styles.headline, { fontFamily: "Tajawal_700Bold" }]}>
              ابدأ يومك بذكر الله
            </Text>
            <Text style={[styles.sub, { fontFamily: "Tajawal_500Medium" }]}>
          ...
          <View style={[styles.ringWrap, { width: size, height: size }]}>
            ...
            <View style={styles.ringCenter} pointerEvents="none">
              <Text style={[styles.percent, { fontFamily: "Tajawal_700Bold" }]}>
                {overallPercent}%
              </Text>
              <Text style={[styles.percentLabel, { fontFamily: "Tajawal_400Regular" }]}>
                إنجاز اليوم
              </Text>
            </View>
          </View>
