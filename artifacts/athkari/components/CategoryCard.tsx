  ...
  return (
    ...
    >
      ...
      <View style={styles.center}>
        ...
        <Text
          style={[styles.subtitle, { color: colors.mutedForeground, fontFamily: "Tajawal_400Regular" }]}
        >
          {category.subtitle}
        </Text>
        <View style={styles.metaRow}>
          <Text style={[styles.percent, { color: colors.primary, fontFamily: "Tajawal_700Bold" }]}>
            {percent}%
          </Text>
          <Text
            style={[styles.count, { color: colors.mutedForeground, fontFamily: "Tajawal_500Medium" }]}
          >
            {done} / {total}
          </Text>
        </View>
