    ...
    >
      <View style={styles.backdrop}>
        <View style={[styles.card, { backgroundColor: colors.card }]}>
          ...
          <Text
            style={[styles.subtitle, { color: colors.mutedForeground, fontFamily: "Tajawal_500Medium" }]}
          >
          ...
          <View style={styles.progressWrap}>
            ...
            <Text style={[styles.progressText, { color: colors.mutedForeground, fontFamily: "Tajawal_500Medium" }]}>
          ...
          <View style={styles.tipsBox}>
            <View style={styles.tipRow}>
              ...
              <Text
                style={[styles.tipText, { color: colors.foreground, fontFamily: "Tajawal_400Regular" }]}
              >
          ...
          >
            ...
            >
              ...
              <Text style={[styles.confirmText, { fontFamily: "Tajawal_700Bold" }]}>
