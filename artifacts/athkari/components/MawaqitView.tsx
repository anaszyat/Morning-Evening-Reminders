  ...
  return (
    ...
    >
      <View style={styles.heroShadow}>
        ...
        >
          ...
          <View style={styles.heroTop}>
            ...
            >
              <Feather
                ...
                color="#fff"
              />
              <Text style={[styles.pillText, { fontFamily: "Cairo_500Medium" }]}>
                تنبيهات الأذان
              </Text>
            </Pressable>
          ...
          <View style={styles.heroCenter}>
            <Text style={[styles.heroLabel, { fontFamily: "Cairo_400Regular" }]}>
              متبقي على الأذان
            </Text>
            <Text style={[styles.heroPrayer, { fontFamily: "Cairo_700Bold" }]}>
              {prayerLabels[next.key]}
            </Text>
            <View style={styles.countWrap}>
              <Text style={[styles.countdown, { fontFamily: "Cairo_700Bold" }]}>
          ...
          <View style={styles.heroBottom}>
            <Text style={[styles.heroBottomTime, { fontFamily: "Cairo_600SemiBold" }]}>
              {formatTime12(next.time)}
            </Text>
            <View style={styles.nextRow}>
              <Feather name="sun" size={14} color="#FCD34D" />
              <Text style={[styles.heroBottomLabel, { fontFamily: "Cairo_400Regular" }]}>
                الأذان القادم
              </Text>
            </View>
          </View>
      ...
      <View style={[styles.sunriseBox, { backgroundColor: colors.card, borderColor: colors.border }]}>
        <Text style={[styles.sunriseTime, { color: colors.foreground, fontFamily: "Cairo_700Bold" }]}>
          {formatTime12(times.sunrise)}
        </Text>
        <View style={{ flex: 1, alignItems: "flex-end" }}>
          <Text style={[styles.sunriseTitle, { color: colors.foreground, fontFamily: "Cairo_700Bold" }]}>
            الشروق
          </Text>
          <Text style={[styles.sunriseSub, { color: colors.mutedForeground, fontFamily: "Cairo_400Regular" }]}>
            وقت ممنوع للصلاة
          </Text>
        </View>
