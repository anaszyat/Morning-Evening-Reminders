  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={[styles.distance, { color: colors.mutedForeground, fontFamily: "Tajawal_500Medium" }]}>
        ...
        <Text style={[styles.angle, { color: colors.foreground, fontFamily: "Tajawal_700Bold" }]}>
          {Math.round(qiblaBearing)}°
        </Text>
        <Text style={[styles.angleLabel, { color: aligned ? colors.success : colors.mutedForeground, fontFamily: "Tajawal_500Medium" }]}>
        ...
        {accuracyHint === "low" && hasSensor && (
          ...
          >
            ...
            <Text
              style={[styles.warningText, { color: "#B45309", fontFamily: "Tajawal_500Medium" }]}
            >
        ...
        {!hasSensor && (
          <View style={[styles.notice, { backgroundColor: colors.accent }]}>
            ...
            <Text
              style={[
                styles.noticeText,
                { color: colors.accentForeground, fontFamily: "Tajawal_500Medium" },
              ]}
            >
              {Platform.OS === "web"
      ...
      >
        <View style={styles.tipRow}>
          ...
          <View style={{ flex: 1, alignItems: "flex-end" }}>
            <Text style={[styles.tipTitle, { color: colors.foreground, fontFamily: "Tajawal_700Bold" }]}>
              نصائح لاستخدام البوصلة
            </Text>
            <Text style={[styles.tipText, { color: colors.mutedForeground, fontFamily: "Tajawal_400Regular" }]}>
